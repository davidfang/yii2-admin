...
<div class="<?php echo Inflector::camel2id(StringHelper::basename($generator->modelClass)) ?>-view">
    ...
    <p>
        ...
        if(Helper::checkRoute('update')) {
            echo Html::a(<?php echo $generator->generateString('Update') ?>, ['update', <?php echo $urlParams ?>], ['class' => 'btn btn-primary']);
        }
        ?>
        <?php echo "<?php " ?>
        //没有删除权限不显示按钮
        if(Helper::checkRoute('delete')) {
            echo Html::a(<?php echo $generator->generateString('Delete') ?>, ['delete', <?php echo $urlParams ?>], [
