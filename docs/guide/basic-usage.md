...
'modules' => [
    ...
    'admin' => [
        'class' => 'zc\admin\Module',
        'layout' => 'left-menu', // it can be '@path/to/your/layout'.
        'controllerMap' => [
            'assignment' => [
                'class' => 'zc\admin\controllers\AssignmentController',
...
The code below shows how to use ACF which is implemented as `zc\admin\components\AccessControl`:

```php
'as access' => [
    'class' => 'zc\admin\components\AccessControl',
    'allowActions' => [
        'site/login',
        'site/error',
    ]
